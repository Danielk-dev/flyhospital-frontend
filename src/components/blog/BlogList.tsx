			...
			<div className="container">
				...
				{!loading && !error && (
					<div className="blog-slider-container">
						<button className="blog-slider-arrow blog-prev-arrow" onClick={prevSlide} disabled={currentIndex === 0}>&#10094;</button>
						<div className="blog-slider-wrapper">
							<div className="blog-slider-track" style={{ transform: `translateX(-${currentIndex * (100 / slidesPerView)}%)` }}>
									...
									<div key={blog.id} className="blog-slide">
										<div className="blog-card">
											...
											<div className="blog-content">
												...
												<p className="blog-truncate-lines">{stripHtml(blog.content)}</p>
						...
						<button className="blog-slider-arrow blog-next-arrow" onClick={nextSlide} disabled={currentIndex >= maxIndex}>&#10095;</button>
					</div>
				)}
